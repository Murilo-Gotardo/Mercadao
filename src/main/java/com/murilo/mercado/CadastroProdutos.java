...
public class CadastroProdutos extends javax.swing.JFrame {
    ...
    private void salvarBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTNActionPerformed
        ...
        Produto produto = new Produto(name.getText(), description.getText(), Double.parseDouble(weigth.getText()), Double.parseDouble(value.getText()));
    ...
    private void removerBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removerBTNActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            Mercado.getProdutos().removeIf(produto -> selectedId.equals(produto.getId()));
        }
